...
def main():
    ...
    log_filename = f"rppo_training_log_{timestamp}.log"
    logging.basicConfig(filename=log_filename, level=logging.INFO)

    # Redirecionar stdout e stderr para o ficheiro
    ...
    checkpoint = CheckpointCallback(save_freq=10000, save_path=checkpoint_path, name_prefix='r_ppo')
    ...
    try:
        ...
        model.save("r_ppo_thymio_no_fall_interrupt")
