...
TIME_STEP = 64
POPULATION_SIZE = 30  # Usando o seu valor mais recente
PARENTS_KEEP = 4      # O número de indivíduos de elite que sobrevivem diretamente
GENERATIONS = 300
MUTATION_RATE = 0.20  # Taxa de mutação mais alta para exploração
MUTATION_SIZE = 0.4   # Tamanho de mutação maior para saltos mais largos
