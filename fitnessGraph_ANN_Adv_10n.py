...
# Carregar os dados
df = pd.read_csv('./data/fitness_history_ANN_advanced_10n.csv')
...
plt.tight_layout()
plt.savefig('./data/fitness_ann_adv_plot_10n.png', dpi=150)
plt.show()
...
plt.legend(loc='upper left')
plt.tight_layout()
plt.savefig('./data/fitness_ann_adv_plot_10n_collisions.png', dpi=150)
plt.show()
